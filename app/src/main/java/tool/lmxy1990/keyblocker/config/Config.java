package tool.lmxy1990.keyblocker.config;
...
public class Config {
    ...
    public static String APPWIDGET_CLICK_ACTION = "tool.lmxy1990.keyblocker.action.APPWIDGET_CLICK_ACTION";
    public static String APPWIDGET_UPDATE_ACTION = "tool.lmxy1990.keyblocker.action.APPWIDGET_UPDATE_ACTION";
    public static String REMOTE_CONTROL_ACTION = "tool.lmxy1990.keyblocker.action.REMOTE_CONTROL_ACTION";
    public static String NOTIFICATION_CLICK_ACTION = "tool.lmxy1990.keyblocker.Notification.OnClick";
    public static String NOTIFICATION_DELETE_ACTION = "tool.lmxy1990.keyblocker.Notification.OnDelete";
